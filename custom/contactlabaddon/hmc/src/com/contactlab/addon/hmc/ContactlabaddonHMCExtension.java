 ...
 *  
 */
package com.contactlab.addon.hmc;
...
/**
 * Provides necessary meta information about the contactlabaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class ContactlabaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ContactlabaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.contactlab.addon.hmc.locales";
