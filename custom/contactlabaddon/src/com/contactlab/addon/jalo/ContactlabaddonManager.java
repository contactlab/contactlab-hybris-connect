 ...
 *  
 */
package com.contactlab.addon.jalo;
...
import com.contactlab.addon.constants.ContactlabaddonConstants;



/**
 * This is the extension manager of the Contactlabaddon extension.
 */
public class ContactlabaddonManager extends GeneratedContactlabaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ContactlabaddonManager.class.getName());
	 ...
	 */
	public static ContactlabaddonManager getInstance()
	{
		return (ContactlabaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ContactlabaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ContactlabaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ContactlabaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ContactlabaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ContactlabaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
