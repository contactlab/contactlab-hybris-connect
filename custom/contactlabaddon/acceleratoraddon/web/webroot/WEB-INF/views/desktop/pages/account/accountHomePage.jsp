	...
	<div class="span-20 last customAccount">
		<cms:pageSlot position="TopContent" var="feature" element="div" class="span-20 wide-content-slot cms_disp-img_slot">
			<cms:component component="${feature}"/>
				...
				<div class="tile column newsletter">
					<c:url value="/my-account/newsletter" var="encodedUrl" />
					<div class="headline"><a href="${encodedUrl}"><spring:theme code="text.account.newsletter" text="Newsletter"/></a></div>
					<ul>
						<ycommerce:testId code="myAccount_options_orderHistory_groupbox">
							<li><a href="${encodedUrl}"><spring:theme code="text.account.newsletterDescription" text="Manage your subscriptions"/></a></li>
						</ycommerce:testId>
					</ul>
				</div>
