...
<div id="accountNav" class="span-4">
		...
		<div class="headline"><spring:theme code="text.account.yourAccount" text="Your Account"/></div>
			...
			<ul>
				...
				<li class='${selected eq 'newsletter' ? 'active' : ''}'>
					<c:url value="/my-account/newsletter" var="encodedUrl" />
					<ycommerce:testId code="myAccount_newsletter_navLink">
						<a href="${encodedUrl}"><spring:theme code="text.account.newsletter" text="Newsletter"/></a>
					</ycommerce:testId>
				</li>
