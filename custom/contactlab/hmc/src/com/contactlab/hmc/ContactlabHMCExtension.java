...
/**
 * Provides necessary meta information about the emailmarketing hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class ContactlabHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ContactlabHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "it.contactlab.hmc.locales";
